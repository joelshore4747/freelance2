...
export default function HomePageClient() {
    ...
    const worksData = [
        ...
        },
        {
            ...
            description:
                "User-friendly mobile app design for a fitness tracking application with social features.",
...
// Recenter when switching category tabs (and nudge mobile carousel to first too)
    useEffect(() => {
        ...
        const id2 = requestAnimationFrame(() => { try { worksCarousel.scrollToIndex(0); } catch {} });
...
// === /FEATURED WORK additions ===
    ...
    return (
        <div className="min-h-screen bg-background">
                    ...
                    <div className="hidden lg:grid grid-cols-2 gap-12 lg:gap-20 items-center">
                        <div className="text-left animate-fade-in-up">
                            ...
                            <p className="text-base md:text-lg lg:text-xl text-muted-foreground font-serif mb-8 lg:mb-14 max-w-2xl text-pretty leading-relaxed animate-fade-in-up animation-delay-300">
                                A two-person studio specializing in modern web design, development, and user experiences that drive measurable
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 lg:gap-6 animate-fade-in-up animation-delay-600">
                                <GetStartedButton size="lg" className="font-serif font-semibold text-base px-8 py-4 hover:scale-105 transition-transform" />
                        ...
                        <div className="relative animate-fade-in-right parallax-element">
                            <div className="relative bg-card rounded-3xl p-6 lg:p-10 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105 animate-float">
                                <img src="/modern-ecommerce-interface.png" alt="Modern web interface" className="w-full h-auto rounded-2xl shadow-2xl" />
            ...
            {/* Services */}
            <section className="py-10 lg:py-28 bg-section-muted text-section-white-foreground">
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                    <div className="text-left lg:text-center mb-20">
                        <h2 className="scroll-animate text-3xl md:text-4xl lg:text-5xl font-bold text-black dark:text-white font-sans mb-1 lg:mb-8 text-balance opacity-0 translate-y-8 tracking-tight">
                        ...
                        <p className="scroll-animate text-xl md:text-2xl text-muted-foreground font-serif max-w-4xl mx-auto lg:mx-auto md:mx-0 text-pretty leading-relaxed opacity-0 translate-y-8 animation-delay-300 font-light">
                            From concept to launch, we handle every aspect of your digital presence with expertise and attention to detail.
                        </p>
                    </div>
                    {/* Desktop grid */}
                                        ...
                                        <ul className="space-y-2 mb-8">
                                            {service.features.map((feature, featureIndex) => (
                                                <li key={featureIndex} className="flex items-start gap-3">
                                                    ...
                                                    <span className="services-feature-text text-sm text-black dark:text-white leading-snug font-light">{feature}</span>
                                                </li>
                                            ))}
                                        </ul>
                    ...
                    <div className="lg:hidden relative">
                        <div ref={servicesCarousel.scrollRef} className="flex gap-6 overflow-x-auto scrollbar-hide snap-x snap-mandatory pb-4" style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}>
                            {servicesData.map((service, index) => (
                        ...
                        <div className="flex justify-center items-center gap-6 mt-12">
                            <button onClick={servicesCarousel.prevSlide} className="p-3 rounded-full bg-primary/10 hover:bg-primary/20 transition-all duration-300 shadow-apple hover:shadow-apple-hover" aria-label="Previous service">
                            ...
                            <button onClick={servicesCarousel.nextSlide} className="p-3 rounded-full bg-primary/10 hover:bg-primary/20 transition-all duration-300 shadow-apple hover:shadow-apple-hover" aria-label="Next service">
            ...
            {/* Process */}
            <section className="pt-4 md:pt-6 lg:pt-8 pb-20 md:pb-32 lg:pb-48 bg-section-muted text-section-muted-foreground">
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                    ...
                    <div className="hidden lg:block relative">
                        ...
                        <div className="grid grid-cols-4 gap-10">
                            {[
                                { step: "01", icon: <Users className="h-8 w-8" />, title: "Discovery", description: "We dive deep into your business goals, target audience, and project requirements." },
                                { step: "02", icon: <Target className="h-8 w-8" />, title: "Strategy", description: "We create a comprehensive plan and wireframes that align with your objectives." },
                                { step: "03", icon: <Palette className="h-8 w-8" />, title: "Design", description: "We craft beautiful, user-centered designs that reflect your brand identity." },
                                { step: "04", icon: <Rocket className="h-8 w-8" />, title: "Launch", description: "We develop, test, and deploy your project with ongoing support and optimization." },
                            ].map((process, index) => (
                                <div key={index} className="text-center relative animate-fade-in-up group" style={{ animationDelay: `${index * 200}ms` }}>
                                    ...
                                    <div className="text-sm font-bold text-section-muted-foreground font-sans mb-3">STEP {process.step}</div>
                                    <h3 className="text-xl font-bold text-section-muted-foreground font-sans mb-4">{process.title}</h3>
                                    <p className="text-section-muted-foreground/80 font-serif text-pretty text-base leading-relaxed">{process.description}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="lg:hidden">
                            ...
                            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-6 py-3">
                                {[1, 2, 3, 4].map((step, index) => (
                                    <div key={step} className="flex items-center">
                                        <button onClick={() => setActiveStep(index)} className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-300 ${index === activeStep ? "bg-primary text-white scale-110" : "bg-white/20 text-section-muted-foreground hover:bg-white/30"}`}>
                                            {step}
                                        </button>
                        ...
                        <div className="flex justify-center mb-6">
                            <div className="w-72">
                                {[
                                    { step: "01", icon: <Users className="h-8 w-8" />, title: "Discovery", description: "We align on goals, audience, scope, and success metrics with short workshops and research sprints.", link: "What we deliver" },
                                    { step: "02", icon: <Target className="h-8 w-8" />, title: "Strategy", description: "Information architecture, user flows, and low-fi wireframes that map the shortest path to value.", link: "See approach" },
                                    { step: "03", icon: <Palette className="h-8 w-8" />, title: "Design", description: "We craft beautiful, user-centered designs that reflect your brand identity and convert visitors.", link: "View designs" },
                                    { step: "04", icon: <Rocket className="h-8 w-8" />, title: "Launch", description: "We develop, test, and deploy your project with ongoing support and optimization for success.", link: "Launch process" },
                                ].map((process, index) => (
                                    <div key={index} className={`transition-all duration-500 ${index === activeStep ? "opacity-100 scale-100" : "opacity-0 scale-95 absolute"}`}>
                                        {index === activeStep && (
                                            <div className="bg-white rounded-2xl p-8 shadow-2xl min-h-[400px] flex flex-col">
                                                ...
                                                <div className="text-sm font-bold text-primary font-sans mb-4 text-center">STEP {process.step}</div>
                                                <h3 className="text-2xl font-bold text-gray-900 font-sans mb-4 text-center">{process.title}</h3>
                                                <p className="text-gray-600 font-serif text-sm leading-relaxed text-center mb-8 flex-grow">{process.description}</p>
                                                <div className="text-center mt-auto">
                                                    <button className="text-primary font-medium text-sm hover:text-primary/80 transition-colors">{process.link} →</button>
                                                </div>
                                            </div>
                                        )}
                                    </div>
                        ...
                        <div className="flex justify-center gap-2">
                            {[0, 1, 2, 3].map((index) => (
                                <button key={index} onClick={() => setActiveStep(index)} className={`h-2 rounded-full transition-all duration-300 ${index === activeStep ? "w-8 bg-primary" : "w-2 bg-gray-300"}`} />
                            ))}
                        </div>
                    </div>
                </div>
            ...
            {/* === FEATURED WORK — aligned with nav, Apple-style, thin/wide cards === */}
            <section className="relative isolate overflow-hidden py-36 lg:py-[12rem] bg-section-white text-section-white-foreground">
                ...
                <div
                    aria-hidden
                    className="absolute inset-0 -z-10 bg-gradient-to-br from-primary/20 via-transparent to-standout/20
               [background-size:200%_200%] [animation:bg-pan_18s_ease-in-out_infinite]"
                />

                {/* Header container (this is our alignment reference) */}
                        ...
                        <div className="flex flex-wrap justify-center gap-3 mb-12">
                            {workCategories.map((category) => (
                                <button
                                    ...
                                    className={cn(
                                        // all pills now larger + consistent
                                        "px-7 py-3 rounded-full text-lg transition-all relative font-semibold",
                ...
                {/* DESKTOP rail (full-bleed wrapper, but left padding matches container) */}
                <div className="hidden lg:block relative">
                    <div className="-mx-4 sm:-mx-6 lg:-mx-8 relative">
                        ...
                        >
                            {filteredWorks.map((work) => (
                                <article
                                    key={work.id}
                                    className="fw-card snap-center flex-shrink-0 rounded-[20px] overflow-hidden bg-black ring-1 ring-white/10 shadow-2xl transition-transform duration-500 hover:scale-[1.01]"
                                    style={{ width: "var(--fw-card-w)" }}  // width is set in the effect
                                >
                                    {/* Thin rectangle media */}
                                    <div className="relative" style={{ aspectRatio: "21/9" }}>
                                        <img
                                            ...
                                            loading="lazy"
                                        />
                                        <span className="absolute top-4 left-4 px-3 py-1.5 rounded-full text-xs font-medium backdrop-blur bg-standout/70 text-white">
                {work.category}
              </span>
                                    </div>
                                    ...
                                    <div className="p-8 md:p-10">
                                        <h3 className="text-[clamp(1.8rem,1.3vw+1rem,2.3rem)] font-bold text-white mb-2">
                                            {work.title}
                                        </h3>
                                        <p className="text-standout/90 font-semibold text-[clamp(1rem,0.55vw+0.95rem,1.25rem)] mb-4">
                                            {work.company}
                                        </p>
                                        <p className="text-white/80 text-[clamp(1.1rem,0.7vw+1rem,1.35rem)] leading-relaxed mb-6">
                                            {work.description}
                                        </p>

                                        <div className="flex flex-wrap gap-3 mb-8">
                                            {work.tags.map((tag: string) => (
                                                <span key={tag} className="tech-tag text-[clamp(1rem,0.35vw+0.95rem,1.15rem)]">
                    {tag}
                  </span>
                                            ))}
                                        </div>
                                        ...
                                        <Link
                                            ...
                                            className={cn(
                                                ...
                                                "h-16 px-10 rounded-full text-lg font-semibold"
                                            )}
                                        >
                                            View Case Study
                                        </Link>
                    ...
                    {/* Centered controls: arrows next to dots (white pill / black icon via theme vars) */}
                            ...
                            {filteredWorks.map((_, i) => (
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        i === fwActive
                                            ? "w-12 bg-white border-white/70"
                                            : "w-3.5 bg-white/25 border-white/40 hover:bg-white/45"
                                    )}
                                />
                            ))}
                        </div>
                ...
                {/* MOBILE: keep your carousel logic; slightly larger UI */}
                <div className="lg:hidden relative mt-10">
                    ...
                    >
                        {filteredWorks.map((work) => (
                            <div
                                key={work.id}
                                className="featured-work-card flex-shrink-0 w-[22.5rem] snap-center rounded-2xl overflow-hidden bg-card/60 ring-1 ring-white/10"
                            >
                                <div className="relative" style={{ aspectRatio: "21/9" }}>
                                    <img
                                        src={work.image || "/placeholder.svg"}
                                        ...
                                        className="w-full h-full object-cover"
                                    />
                                    <span className="absolute top-4 left-4 bg-standout text-white px-2.5 py-1.5 rounded text-xs font-semibold">
              {work.category}
            </span>
                                </div>

                                <div className="p-6">
                                    <h3 className="text-[1.55rem] font-bold text-card-foreground mb-1">
                                        {work.title}
                                    </h3>
                                    <p className="text-standout font-semibold text-sm mb-3">
                                        {work.company}
                                    </p>
                                    <p className="text-muted-foreground text-[1.1rem] leading-relaxed mb-4">
                                        {work.description}
                                    </p>
                                    <div className="flex flex-wrap gap-2.5 mb-6">
                                        {work.tags.map((tag) => (
                                            <span key={tag} className="tech-tag text-[1rem]">
                  {tag}
                </span>
                                        ))}
                                    </div>
                    ...
                    {/* Mobile controls you already had can remain, or use dots only */}
                            ...
                            {filteredWorks.map((_, index) => (
                                <button
                                    ...
                                    className={`h-2.5 rounded-full transition-all ${
                                        index === worksCarousel.currentIndex
                                            ? "w-10 bg-standout"
                ...
                {/* View all — larger, bordered, colored */}
